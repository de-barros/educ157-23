...
.box-1.medium.sp-after-half[Arbitrary cutoffs and causal inference]

--

.box-3.medium.sp-after-half[Drawing lines and measuring gaps]

--

.box-6.medium.sp-after-half[Main concerns]

--

.box-7.medium.sp-after-half[Non-compliance or "fuzziness"]
...
.box-inv-1.sp-after[Instead of using carefully adjusted DAGs,<br>we can use *context* to isolate/identify the pathway between<br>treatment and outcome in observational data]

--

.box-1[Regression discontinuity designs (RDD) are one type of such "quasi-experiments"]

.box-inv-1[Quantifiable rules determine access to programs]

.box-inv-1[Main idea: Randomness of who<br>*just qualifies* for a program vs. *just doesn't qualify*]

---

# Rules to access programs

.box-inv-1.medium[Lots of policies and programs are<br>based on arbitrary rules and thresholds]

--

.box-1[If you're above the threshold, you're in the program;<br>if you're below, you're not (or vice versa)]
...
.box-inv-1.medium[Running / forcing variable]

.box-1.sp-after[Index or measure that determines eligibility]

--

.box-inv-1.medium[Cutoff / cutpoint / threshold]

.box-1[Number that formally assigns access to program]
...
.pull-right-narrow[
.box-inv-1.smaller[**Medicaid**<br>138%*]

.box-inv-1.smaller[**ACA subsidies**<br>138–400%*]

.box-inv-1.smaller[**CHIP**<br>200%]

.box-inv-1.smaller[**SNAP/Free lunch**<br>130%]

.box-inv-1.smaller[**Reduced lunch**<br>130–185%]
]
...
.box-inv-1.medium[Students take an entrance exam]

--

.box-inv-1.medium[Those who score 70 or lower<br>get a free tutor for the year]

--

.box-inv-1.medium[Students then take an exit exam<br>at the end of the year]
...
.box-inv-1.medium[The people right around the threshold are essentially the same]
...
.box-1.medium[Pseudo treatment and control groups!]

--

.box-inv-1.medium[Compare outcomes for those<br>right above/below, calculate difference]
...
.pull-right-narrow[
.box-inv-1[Lower turnout in counties on the eastern side of the boundary]

.box-inv-1[Election schedules cause fluctuations in turnout]
]
...
.pull-right-narrow[
.box-inv-1[California requires that insurance cover two days of post-partum hospitalization]

.box-inv-1[Does extra time in the hospital improve health outcomes?]
]
...
.center[
<figure>
  <img src="img/10/hospitals-1.png" alt="Hospital stays duration" title="Hospital stays duration" width="100%">
</figure>
]

.box-inv-1[Delivering at 12:01 AM makes you stay longer in the hospital…]
...
.box-inv-1[…but delivering at 12:01 AM has no effect on readmission rates or mortality rates]
]
...
.pull-right-narrow[
.box-inv-1[Does going to the main state university (e.g., CSU) make you earn more money?]

.box-inv-1[SAT scores are an arbitrary cutoff for accessing the university]
]
...
.pull-left.center[
<figure>
  <img src="img/10/flagship-1.png" alt="Flagship cutoff" title="Flagship cutoff" width="100%">
</figure>

.box-inv-1[Cutoff seems rule-based]
]
...
.box-inv-1[Earnings are slightly higher]
]
...
.box-inv-1.medium[People love these things!]

--

.box-1[They're intuitive, compelling, and highly graphical]
...
.pull-right[
.box-1[RDD less susceptible to p-hacking and selective publication than DID or IV]
]
...
.box-inv-3.medium[Measure the gap in outcome for<br>people on both sides of the cutpoint]

--

.box-inv-3.medium[Gap = **δ** =<br>local average treatment effect (LATE)]
...
.box-inv-3.medium[The size of the gap depends on how<br>you draw the lines on each side of the cutoff]

--

.box-inv-3.medium.sp-after[The type of lines you choose can<br>change the estimate of δ—sometimes by a lot!]

--

.box-3.medium[There's no one right way to draw lines!]
...
.box-inv-3.medium[Parametric vs. non-parametric lines]

--

.box-inv-3.medium[Measuring the gap]

--

.box-inv-3.medium[Bandwidths]

--

.box-inv-3.medium[Kernels]

---

# Parametric lines

.box-inv-3.medium[Formulas with *parameters*]
...
.box-inv-3.medium[Not just for straight lines!<br>Make curvy with exponents or trigonometry]
...
.box-inv-3.medium.sp-after[It's important to get the parameters right!]

--

.box-inv-3.medium[Line should fit the data pretty well]
...
.box-inv-3.medium[Lines without parameters]

--

.box-3[Use the data to find the best line,<br>often with windows and moving averages]

--

.box-3[<span style="color: #F6D645;">Lo</span>cally <span style="color: #F6D645;">e</span>stimated/<span style="color: #F6D645;">we</span>ighted <span style="color: #F6D645;">s</span>catterplot <span style="color: #F6D645;">s</span>moothing (LOESS/LOWESS)<br>is a common method (but not the only one!)]
...
.box-inv-3[Easiest way: center the running variable around the threshold]
...
.box-inv-3[Can't use regression; use `rdrobust` R package]
...
.box-inv-3.medium[All you really care about is the<br>area right around the cutoff]

.box-3.sp-after[Observations far away don't matter<br>because they're not comparable]

--

.box-inv-3.medium[Bandwidth = window around cutoff]
...
.box-inv-3.medium.sp-after[Algorithms exist to choose optimal width]

--

.box-inv-3.medium[Also use common sense]

.box-3.sp-after[Maybe ±5 for the entrance exam?]

--

.box-inv-3.medium[For robustness, check what happens<br>if you double and halve the bandwidth]
...
.box-inv-3.medium[Because we care the most about<br>observations right by the cutoff,<br>give more distant ones less weight]

--

.box-inv-3.medium[Kernel = method for assigning importance to<br>observations based on distance to the cutoff]
...
.box-inv-3.medium[Your estimate of δ depends on all these:]

--

.box-inv-3[Line type (parametric vs. nonparametric)]

.center[
.float-left[.box-inv-3[Bandwidth (wide vs. narrow)]&ensp;.box-inv-3[Kernel weighting]]
]
...
.box-3.medium[Try lots of different combinations!]
...
.box-inv-6.smaller[*(But can you really do that with RCTs?)*]
...
# 🎵 don't know about you, feeling 26.2

.center[
<figure>
  <img src="img/10/marathons.png" alt="Marathon times" title="Marathon times" width="85%">
</figure>
]
...
.box-inv-7.medium[People on the margin of the cutoff<br>might end up in/out of the program]

--

.box-7.sp-after[The ACA, subsidies, Medicaid, and 138% of the poverty line]

--

.box-inv-7.medium[Sharp vs. fuzzy discontinuities]

---

# Sharp discontinuity

.box-inv-7[Perfect compliance]
...
.box-inv-7[Imperfect compliance]
...
.box-inv-7.medium[Address noncompliance with<br>instrumental variables<br>]

--

.box-7.sp-after[Use an instrument for which side<br>of the cutoff people should be on]

--

.box-inv-7[Effect is only for compliers near the cutoff<br>(complier LATE; doubly local effect)]

---

# Fuzzy discontinuities

.box-inv-7.medium.sp-after[Fuzzy discontinuities imply noncompliance]

--

.box-inv-7.medium[Address noncompliance with<br>instrumental variables]
...
.box-inv-7.medium[Instrument = above/below cutoff]

.box-7.small.sp-after[i.e. what they were supposed to do]

&nbsp;

--

.box-7.medium.sp-before[(This is just like the CACE we did last week!)]
...
.pull-left[
.box-inv-7.less-medium[Relevant?]

.box-inv-7.tiny.sp-after[Z → X &emsp; Cor(Z, X) ≠ 0]

.box-7.small[Cutoff causes program? Yep.]
]

--

.pull-right.sp-after-half[
.box-inv-7.less-medium[Exclusive?]

.box-inv-7.tiny.sp-after[Z → X → Y &emsp; Z &nrarr; Y &emsp; Cor(Z, Y | X) = 0]

.box-7.small[Cutoff causes outcome<br>*only through* program? Yep.]
]

--

.box-inv-7.less-medium[Exogenous?]

.box-inv-7.tiny.sp-after[U &nrarr; Z &emsp; Cor(Z, U) = 0]

.box-7.small[Unobserved things that influence outcome don't also influence cutoff?<br>It's an arbitrary cutoff, so sure.]

---

# Doubly local LATE

.box-inv-7.medium[Effect is only for<br>(1) compliers (2) near the cutoff]

.box-7[Be specific when talking about effects;<br>definitely don't make population-level claims]
...
.box-inv-8.small.sp-after[Submit on Canvas, look at Slack]


--

.box-8.medium[**Milestone 3**]

.box-inv-8.small.sp-after[Start thinking about your identification strategy (IV, RD, Dif-in-Dif)]

--

.box-8.medium[**Submit DAM 3**]

.box-inv-8.small[Contact me by Friday if you have any questions]
