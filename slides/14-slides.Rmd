...
.box-1.medium.sp-after-half[Case study]

--

.box-3.medium.sp-after-half[Before-after, two groups]
...
No! Not possible because maybe other things happened to the group of high-intensity regions to cause that – there's no control group to compare with. This group would have also experience the same "shocks" as that region.
...
No! Not possible because maybe other things happened to the different cohorts to cause that – there may be secular trends going.
...
node_details <- tribble(
  ...
  "time", "Program intensity (region)", 2, 3,
  "nj", "Eligibility (cohort/age)", 2, 1
)
...
dd <- tribble(
  ~` `, ~`Too old`, ~`Eligible age`, ~`<span class='color-light-1'>∆ <span class='smaller'>(eligible − ineligible)</span></span>`,
  "Low-intensity", "<b>A</b><br><span class='small'>(never treated)</small>", "<b>B</b><br><span class='small'>(treated a little)</small>", "<b>B − A</b>",
  "High-intensity", "<b>C</b><br><span class='small'>(never treated)</small>", "<b>D</b><br><span class='small'>(treated a lot)</small>", "<b>D − C</b>",
  "∆<br><span class='smaller'>(high − low)</span>", "<b>C − A</b>", "<b>D − B</b>", "<span class=''><b>(D − C) − (B − A)</b></span> <i>or</i><br><span class=''><b>(D − B) − (C − A)</b></span>"
)
...
.box-1[∆ (eligible − ineligible) = **across-cohort difference**]
...
.box-1[∆ (high − low-intensity) = **across-region difference**]
...
.box-1[∆<sub>across cohorts</sub> − ∆<sub>across regions</sub> =<br>Difference-in-differences =<br>causal effect!]
...
dd <- tribble(
  ~` `, ~`Too old`, ~`Eligible age`, ~`<span class='color-light-1'>∆ <span class='smaller'>(eligible − ineligible)</span></span>`,
  "Low-intensity", "<b>9.40</b><br><span class='small'>A</small>", "<b>9.76</b><br><span class='small'>B</small>", "<b>0.36</b><br><span class='small'>B − A</small>",
  "High-intensity", "<b>8.02</b><br><span class='small'>C</small>", "<b>8.49</b><br><span class='small'>D</small>", "<b>0.47</b><br><span class='small'>D − C</small>",
  "∆<br><span class='smaller'>(high − low)</span>", "<b>-1.39</b><br><span class='small'>C − A</small>", "<b>-1.27</b><br><span class='small'>D − B</small>", "<b>(-1.27) − (−1.39) = <br><span class='color-1'>0.12</span></b>"
)
...
dd <- tribble(
  ~` `, ~`Pre mean`, ~`Post mean`, ~`<span class='color-light-3'>∆ <span class='smaller'>(post − pre)</span></span>`,
...
.box-3[∆ (post − pre) = **within-unit growth**]
...
.box-3[∆ (treatment − control) = **across-group growth**]
...
dd <- tribble(
  ...
  "Control", "<b>A</b><br><span class='small'>(never treated)</small>", "<b>B</b><br><span class='small'>(never treated)</small>", "<b>B − A</b>",
  "Treatment", "<b>C</b><br><span class='small'>(not yet treated)</small>", "<b>D</b><br><span class='small'>(treated)</small>", "<b>D − C</b>",
  "∆<br><span class='smaller'>(treatment − control)</span>", "<b>C − A</b>", "<b>D − B</b>", "<span class='color-3'><b>(D − C) − (B − A)</b></span> <i>or</i><br><span class='color-3'><b>(D − B) − (C − A)</b></span>"
)
...
.box-3[∆<sub>within units</sub> − ∆<sub>within groups</sub> =<br>Difference-in-differences =<br>causal effect!]
...
dd <- tribble(
  ...
  "∆<br><span class='smaller'>(NJ − PA)</span>", "<b>-2.89</b><br><span class='small'>C − A</small>", "<b>-0.14</b><br><span class='small'>D − B</small>", "<b>(0.59) − (−2.16) = <br><span class='color-3'>2.76</span></b>"
)
...
.box-inv-1.medium[Finding all the group<br>means is tedious!]

--

.box-inv-1.medium.sp-after[What if there are other<br>backdoors to worry about?]

--

.box-1.medium[Regression to the rescue!]
...
<span class="box-1", style="background-color: #666666">α = Mean of control, pre-treatment</span>

--

<span class="box-1", style="background-color: #0074D9">β = Increase in outcome across groups</span>

--

<span class="box-1", style="background-color: #39CCCC">γ = Increase in outcome over time within units</span>

--

<span class="box-1", style="background-color: #FF4136">δ = Difference in differences!</span>
...
.box-inv-6.medium[🎵 And nothing else matters 🎵]
...
.box-inv-8.small.sp-after[Look for my answers on Slack]

.box-inv-8.small.sp-after[For some, this will be reaction #14. Congrats!]

--

.box-8.medium[**DAMs**]

.box-inv-8.small[DAM 3: Review comments]

.box-inv-8.small[DAM 4: Notice sections you can skim]

.box-inv-8.small[DAM 4: Due at the end of the week]
