...
# Review and extension of applied statistics
...
.box-1.medium.sp-after-half[Drawing lines]

--

.box-3.medium.sp-after-half[Lines, Grϵϵκ, and regression]
...
.box-inv-3[Statistics: use a sample to make inferences about a population]
...
.box-inv-3.sp-after[Data → Calculation → Estimate → Truth]
...
.box-inv-3.smaller[(most of the time we can get rid of markings on Greek and just use β)]
...
.box-inv-3.medium[A one unit increase in X is *associated* with<br>a β<sub>1</sub> increase (or decrease) in Y, on average]
...
.box-8.medium[**Start working on DAM 1**]

.box-inv-8.small[Consider teaming up]

.box-inv-8.small[Accept my invitation to our RStudio / Posit cloud workspace]
