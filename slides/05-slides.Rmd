...
.box-inv-1[Background, year of birth, location, job connections, and school requirements all cause education]
...
.box-inv-1[Background, year of birth, and location all cause earnings too]
...
.box-3[E\[ Firm growth | *do*(Government R&D funding)\] ]

--

.box-3[E\[ Air quality | *do*(Carbon tax)\] ]

--

.box-3[E\[ Juvenile delinquency | *do*(Truancy program)\] ]

--

.box-3[E\[ Malaria infection rate | *do*(Mosquito net)\] ]
