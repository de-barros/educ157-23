...
Our dedicated Slack channel is [here](https://educ157-23.slack.com/). Watch out for an email invitation from me. You will post your reading reactions on Slack, not on Canvas.
...
- Rachel Glennerster and Kudzai Takavarasha, *Running Randomized Evaluations* (Princeton University Press, 2014), <https://press.princeton.edu/books/paperback/9780691159270/running-randomized-evaluations> ([**This book has a great companion website**](http://runningres.com/)). 
...
There will also occasionally be additional articles and videos to read and watch. When this happens, links to these other resources will be included on the reading page for that week. For example, we will review two chapters from the following book.  
...
RStudio.cloud is convenient, but it can be slow and it is not designed to be able to handle larger datasets or more complicated analysis. Over the course of the semester, you'll probably want to get around to installing R, RStudio, and other R packages on your computer and wean yourself off of RStudio.cloud. This isn't necessary, but it's helpful. You can [find instructions for installing R, RStudio, and all the tidyverse packages here.](/resource/install.html)

There are tons of online resources to help you with R and RStudio. Two of the most important are [StackOverflow](https://stackoverflow.com/) (a Q&A site with hundreds of thousands of answers to all sorts of programming questions) and [RStudio Community](https://community.rstudio.com/). Also, ChatGPT will sometimes fool you but, as it was trained on StackOverflow (among other websites), it is quite good at writing R code.
...
You should actively participate in class, do all the readings, and discuss them outside of class. To that end, you should post reactions to at least 14 of our readings on Slack. You may (and should) engage with the other reactions you see posted on Slack. However, it'll be up to me to decide whether a comment engages with the assigned reading and adds to the discussion, meaningfully.[^Yey] 

[^Yey]: "Yey" won't do.

### Data-analytic memos

Over the quarter, you will write four "data-analytic memos" (DAMs). You will complete these memos at home, individually. Each DAM will task you to use your newly-acquired evaluation skills. Many of the questions will be similar to what you may be asked to do on a future job (whether as an education practitioner, analyst, or researcher). You will also work with real-life education datasets.
...
**Bump-up policy**: I reserve the right to "bump up" the grades of students who have made valuable contributions to the course in the in-person course and discussions/Slack. This also applies to students who show tremendous progress and growth over the semester. 
