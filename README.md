...
graph LR
  subgraph Graph
    xccb29afdb6aede8f(["gen_nets"]):::built --> xbe28472fe2bce29e(["data_nets"]):::queued
    x676cecdcd5eb7813(["data_plot_barrel_dag_obs"]):::queued --> xa7f6f0c1b16f542a(["copy_plot_barrel_dag_obs"]):::queued
    x6deca4ab95db78c5(["gen_data_bed_nets"]):::built --> x10e4e9d82e7b691d(["data_bed_nets_time_machine"]):::queued
    ...
    xc5cdd24fb6bd9f0e(["gen_village"]):::built --> x4df77a4d5c017917(["data_village_rct"]):::queued
    ...
    x07bd1301298fd82f(["gen_barrel_dags"]):::built --> x676cecdcd5eb7813(["data_plot_barrel_dag_obs"]):::queued
    ...
    x20b85e3488818f5e(["gen_data_tutoring"]):::built --> x5c240766086c102f(["gen_data_tutoring_fuzzy"]):::queued
    xc5cdd24fb6bd9f0e(["gen_village"]):::built --> x7ba0dec890393ab6(["data_village_obs"]):::queued
    xf38d3f5e6365ad72(["workflow_graph"]):::started --> x6e52cb0f1668cc22(["readme"]):::queued
    x1b5d71f80f0ded23(["gen_data_father_educ"]):::built --> x068350206b5f4fee(["data_father_educ"]):::queued
    ...
    x6deca4ab95db78c5(["gen_data_bed_nets"]):::built --> x9d65856d614f77f4(["gen_data_bed_nets_real"]):::queued
    x07bd1301298fd82f(["gen_barrel_dags"]):::built --> xc72ce427df7cb6d6(["data_plot_barrel_dag_rct"]):::queued
    ...
    xbbb6d7ed9a6f640a(["copy_eitc"]):::queued --> x41092a7251862a9e(["copy_data"]):::queued
    ...
    x9c50e551b1b09085(["copy_public_housing"]):::built --> x41092a7251862a9e(["copy_data"]):::queued
    ...
    x20b85e3488818f5e(["gen_data_tutoring"]):::built --> x5cef82ddbf74dbd2(["gen_data_tutoring_sharp"]):::queued
